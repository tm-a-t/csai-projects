---
title: "Problem.Cafe: Collector of STEM Problems"
term: Autumn 2025
type: Term Project
mentors: []
...
High-quality contest and training problems are mostly stored in unstructured formats — PDFs, scans, inconsistent LaTeX — which makes them difficult to search, filter, translate, and reuse. As a result, creation of targeted problem sets requires significant manual effort and does not scale.
...
The result site is available at [problem.cafe](https://problem.cafe).
